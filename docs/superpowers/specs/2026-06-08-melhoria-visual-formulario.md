...
```html
<!-- Antes -->
<button class="btn-novo-form w-10 h-10 flex items-center justify-center
  rounded-xl border border-slate-200 bg-slate-50 text-slate-600
  text-2xl font-semibold shadow-sm ...">+</button>
...
<div class="nav-buttons flex justify-between" id="nav-buttons">  <!-- movido para cá -->
...
<div class="section-wrapper relative ..." id="section-wrapper">
  ...seções...
</div>
