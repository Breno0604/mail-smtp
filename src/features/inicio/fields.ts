...
export const iniciaisFields: FieldDefinition[] = [
  ...
  { linha: 1, nome: "lider", label: "Líder", tipo: "select", obrigatorio: true, opcoes: [...NOMES_TECNICOS] },
  { linha: 2, nome: "parceiro", label: "Parceiro", tipo: "select", obrigatorio: true, opcoes: [...NOMES_TECNICOS] },
  { linha: 3, nome: "municipio", label: "Município", tipo: "select", obrigatorio: true, opcoes: [...MUNICIPIOS] },
  ...
  { linha: 5, nome: "placa", label: "Placa", tipo: "select", obrigatorio: true, opcoes: [...PLACAS] },
  ...
  { linha: 7, nome: "tipo-ordem", label: "Tipo de Ordem", tipo: "select", obrigatorio: true, opcoes: [...TIPOS_ORDEM] },
]
