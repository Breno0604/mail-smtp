...
export const iniciaisFields: FieldDefinition[] = [
  ...
  { linha: 3, nome: "municipio", label: "Município", tipo: "select", obrigatorio: true, opcoes: [
    "ACARAPE","AQUIRAZ","ARACOIABA","ARATUBA","BARREIRA","BATURITE","BEBERIBE",
    "CAPISTRANO","CASCAVEL","CAUCAIA","CHOROZINHO","EUSÉBIO","FORTALEZA",
    "GUAIUBA","GUARAMIRANGA","HORIZONTE","ITAITINGA","ITAPIUNA","MARACANAU",
    "MARANGUAPE","MULUNGU","OCARA","PACAJUS","PACATUBA","PACOTI","PALMACIA",
    "PINDORETAMA","REDENCAO","SAO GONCALO"
  ] },
  ...
  { linha: 5, nome: "placa", label: "Placa", tipo: "select", obrigatorio: true, opcoes: [
    "RHS6G02","RIE0D84","RIH3H88","SDZ7E43","SDZ9B15","SDZ9B16",
    "SRT8J10","SRW6J12","SRW6J13","SRW6J41","TCI4F69","TUL0I49"
  ] },
  ...
  { 
    ...
    obrigatorio: true, 
    opcoes: [
      "ADEQUACAO SMF","AFERIÇÃO DE MEDIDOR","AFERIÇÃO MEDIDOR CLIENTE LIVRE",
      "COLHER LEITURA","CORTE DE UC POR DEF TECNICO","CORTE DEFINITIVO A PEDIDO",
      "CORTE POR FALTA DE PAGAMENTO","DESLIG.PROG.MANUTENÇÃO",
      "DESLOCAMENTO DE SUBESTAÇÃO","DISPON. SAIDA SERIAL MEDIDOR",
      "EXECUÇÃO DE MUDANÇA DE TARIFA","EXECUCAO DO ACRESCIMO DE POTENCIA",
      "EXECUCAO DO DECRESCIMO DE POTENCIA","GRANDES CLIENTES SELO ROMPIDO",
      "GRANDES CLIENTES SEM MEDIÇÃO","INSPECAO UC CORTADA I15",
      "INSPECAO UC CORTADA I180","INSPECAO UC CORTADA I30",
      "INSPECAO UC CORTADA I90","INSTALACAO DO DISPLAY",
      "LIBERAÇÃO DE PULSO","LIGAÇÃO NOVA ISOLADA",
      "LIGACAO NOVA MEDIA TENSAO","LIGACAO NOVA MT - CLIENTE LIVRE",
      "LIGAÇÃO NOVA SIMULTÂNEA","RELIGACAO NORMAL RURAL",
      "RELIGAÇÃO NORMAL URBANA","RESELAR MEDICAO","RESSERVICO",
      "RETIRAR EQUIPAMENTOS","RETIRAR RAMAL","SERVIÇO ESPECIAL OPERAÇÃO GRUPO A",
      "SUBST. DE EQUIPAMENTO DE MEDICAO","SUBST. MEDIDOR A PEDIDO",
      "SUBST. MEDIDOR INICIATIVA COELCE","SUBSTITUIÇÃO DA BATERIA DO MEDIDOR",
      "SUBSTITUIÇÃO DE DISPLAY","TELEMEDIÇÃO MANUTENÇÃO",
      "TELEMEDIÇÃO MANUTENÇÃO CLIENTE LIVRE","TELEMEDIÇÃO MANUTENÇÃO LOTE",
      "VISITA TECNICA GRUPO A","VISTORIA DA UC","VISTORIA GERAÇÃO DISTRIBUIDA"
    ] 
  },
];
...
const FIELD_DESCRICAO: FieldDefinition = { nome: "descricao", label: "Descrição do Serviço", tipo: "textarea" };

// Campos para Inspeção UC Cortada (I15, I30, I90, I180) - mesmos campos, 4 tipos
const UC_CORTADA_FIELDS: FieldDefinition[] = [
...
const LIGACAO_NOVA_MT_FIELDS: FieldDefinition[] = [
...
export const retornoFieldsByTipo: Record<string, FieldDefinition[]> = {
...
export function getRetornoFields(tipo: string): FieldDefinition[] {
  return retornoFieldsByTipo[tipo] || retornoFieldsByTipo["default"];
}

export const retornoFields: FieldDefinition[] = [
  { label: "Descrição", nome: "descricao-retorno", tipo: "textarea", obrigatorio: true },
];