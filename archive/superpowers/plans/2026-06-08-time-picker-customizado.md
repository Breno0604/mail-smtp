...
function buildModal() {
  ...
  for (let h = 0; h < 24; h++) {
    ...
    item.className =
      'h-12 flex items-center justify-center snap-center text-lg text-gray-700 rounded-lg cursor-pointer transition-colors';
  ...
  cancelBtn.className =
    'flex-1 py-3 text-blue-600 font-semibold hover:bg-gray-50 transition-colors';
  cancelBtn.textContent = 'Cancelar';

  const confirmBtn = document.createElement('button');
  confirmBtn.type = 'button';
  confirmBtn.className =
    'flex-1 py-3 bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors';
