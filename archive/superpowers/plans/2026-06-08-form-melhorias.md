...
```html
<div class="container bg-gray-50 rounded-xl shadow-lg p-1 pt-4 w-full max-w-[640px] relative"></div>
```
...
```html
<div
  class="container bg-gray-100 rounded-xl shadow-lg p-1 pt-4 w-full max-w-[640px] relative"
></div>
```
